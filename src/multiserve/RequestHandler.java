...
default : return  "Do you even care about me?" ; 
        ...
        switch(commandChoice){
            case 0 :  return "Ship is at x coordinate " + rand.nextInt(100)+1 + ", y coordinate " + rand.nextInt(100)+1 +"";
             ...
             case  12 :  return conn.getDepartment("science");
              case 13 :  return conn.getDepartment("engineering");
              case  14 : return conn.getDepartment("security");
              case 15 :  return conn.getDepartment("flight crew");
